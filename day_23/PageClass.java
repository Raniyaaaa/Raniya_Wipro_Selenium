...
public class PageClass {
    ...
    By search_btn = By.id("gh-search-btn");
    ...
    public void login_in() throws InterruptedException {
        ...
        driver.findElement(email).sendKeys("raniya182002@gmail.com");
        driver.findElement(cont).click();
        Thread.sleep(2000);
        driver.findElement(pass).sendKeys("Raniya@123");
...
//    }
    ...
    public void rightClickOnProduct() {
        ...
        driver.findElement(search_btn).click();
        WebElement productImage = wait.until(ExpectedConditions.presenceOfElementLocated(watchProduct));
