...
public class AssignmentTestNG {
    ...
    public void beforeTest() {
        ...
        wait = new WebDriverWait(driver, Duration.ofSeconds(10)); // for tricky cases
...
//	  username.sendKeys("raniya182002@gmail.com");
//	  driver.findElement(By.id("signin-continue-btn")).click();
//	  Thread.sleep(3000);
//	  WebElement pass = driver.findElement(By.id("pass"));
//	  pass.sendKeys("Raniya@123");
//	  driver.findElement(By.id("sgnBt")).click();
//	  System.out.println("Login test executed");
//	  Thread.sleep(3000);
//  }
...
//    driver.findElement(By.id("gh-search-btn")).click();
//    Thread.sleep(3000);
//    driver.get("https://www.ebay.com/itm/326013509564?_skw=laptop&itmmeta=01K2KDZ62CRGWXE3VGHHTV04JN&hash=item4be7eb5fbc:g:uXQAAOSwb7ZmoQmm&itmprp=enc%3AAQAKAAAA4FkggFvd1GGDu0w3yXCmi1fJCWC%2BRT44%2F7IaBRPRivy1OGNdQMkAy0j6lo1kpGquPaEtZdRj3Et4euXL3gBjRgyNcRoBD0vkHQNOsF5HB8kj%2BvDExGhVPg7yxwNrkWuqjzAcv7ICrxJwo2yFLq9YpUwCoUs6kZEAtIlB9%2FbzTeSy6kaYJyzGERUdg2P8QRiZRyL6bmFNp16GnKVSZWsWl7w0ybFWOBzBibaHx%2FpzXe5gkH9Hh0%2FzzWvy%2BYXOrn%2BiWY77eAktyR%2FIHImCXXr2aBKYzWJLCopLo7Kh6SEPoPa1%7Ctkp%3ABFBMyuH87ZRm");
//    Thread.sleep(2000);
//    js.executeScript("window.scrollBy(0,300)");
...
//  
//  @Test(priority =4)
//  public void testChangeCurrentAddress() throws InterruptedException {
//	  Thread.sleep(2000);
//	  JavascriptExecutor js =(JavascriptExecutor)driver;
//      driver.findElement(By.linkText("My eBay")).click();
//      driver.findElement(By.linkText("Account")).click();
...
//  
//  @Test(priority =7)
//  public void testRightClickOnProductImage() throws InterruptedException {
//	  Thread.sleep(2000);
//	  driver.findElement(By.id("gh-ac")).clear();
//      driver.findElement(By.id("gh-ac")).sendKeys("Wrist Watch");
//      driver.findElement(By.id("gh-search-btn")).click();
//      WebElement productImage = driver.findElement(By.xpath("//*[@id=\"item2b24cf1791\"]/div/div[1]/div/a/div/img"));
//      actions.contextClick(productImage).perform();   
//      String description = productImage.getAttribute("alt");
//      System.out.println("Product description: " + description);
//      System.out.println("Right clicked image");
...
//    WebElement country= driver.findElement(By.cssSelector("button[class=\"gf-flag__button\"]"));
//    country.sendKeys(Keys.ENTER);
//    driver.findElement(By.linkText("Korea")).click();
//      System.out.println("Language changed to Korean");
//      Thread.sleep(3000);
//  }
//  
